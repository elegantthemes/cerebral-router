  ...
  _createClass(Snapshot, [{
    ...
    value: function createMockedProviders() {
      ...
      this.controller.contextProviders = Object.keys(providers).reduce(function (wrappedProviders, provider) {
        if (providers[provider] instanceof _functionTree.Provider && notWrappedProviders.indexOf(provider) === -1) {
    ...
    value: function mutate(method, path) {
      ...
      this.controller.model[method].apply(this.controller.model, [(0, _utils.ensurePath)(path)].concat(args));
    ...
    value: function run(signalPath, payload) {
      ...
      return new Promise(function (resolve, reject) {
        var pathArray = (0, _utils.ensurePath)(signalPath);
...
exports.default = function (rootModule) {
